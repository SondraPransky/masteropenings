...
6. ~~**Reliquat de l'audit**~~ → **FAIT le 17/07** (indigo-500 parallèle ×17 balayé · 3 vraies ombres claires tokenisées, les ×11 du dark sont un **faux positif** démontré · radius 0 restant · **échelle de z-index créée**, égalité 9999 levée). Détail → bloc « Session du 17 juillet ».
7. ~~**L'ÉDITEUR jamais mesuré sur mobile**~~ → **TRANCHÉ + FAIT le 17/07.** Réponse produit de l'utilisatrice : **oui, les profs l'utiliseront possiblement au téléphone.** Mesuré : le socle tenait déjà (0 débordement, 0 zoom iOS, **drag tactile fonctionnel**) ; 2 défauts « annoter au doigt » corrigés (plateau 276 → **340px** à 375 · NAG 23 → **44×44**) + 2 bugs trouvés en chemin (ghost de drag hors z-scale ; **aucun listener `resize`** → la rotation ne redimensionnait jamais). Desktop strictement inchangé. Détail → bloc « Session du 17 juillet (2e) ».
