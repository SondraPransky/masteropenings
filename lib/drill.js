...
function updateStudyProgress() {
  ...
  const testBtn = document.querySelector('#learn-card .btn-gold'); if (testBtn) testBtn.innerHTML = '<i class="ti ti-player-play" aria-hidden="true"></i> Commencer la révision';
}
