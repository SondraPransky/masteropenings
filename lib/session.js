...
export const S = {
  ...
  sessionIdx: 0,
  // Module a CHAPITRES (varmode tree, plusieurs parties dans le PGN) : arbre du
  // chapitre courant, reconstruit a la volee par startTreeDrill. null = pas de
  // chapitre (l'arbre FUSIONNE du module, S.drill.tree, fait foi — c'est lui que
  // lisent la file SR et la carte eleve).
  chapterTree: null,
  // Mode positions clés
  kps:      [],
  posIdx:   0,
