...
function _syncEditorCommentField() {
  ...
  ta.value = isMove ? (_E.node.comment || '') : '';
  ta.disabled = !isMove;
  ta.placeholder = isMove ? 'Ex : Idée clé de la variante…' : 'Sélectionne un coup dans la notation pour l\'annoter';
...
function editorSaveComment() {
  ...
  _E.node.comment = document.getElementById('editor-comment').value;
