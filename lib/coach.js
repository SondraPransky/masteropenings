  ...
  const cardsHtml = _wsCards.map((p,i) => {
    ...
    return `<div class="wsx-card${p.rate<50?' hot':''}">
      ...
      <div class="wsx-actions">
        <button class="btn btn-blue btn-sm" onclick="openWeakspotPosition(${i})"><i class="ti ti-eye" aria-hidden="true"></i> Voir la position</button>
      </div>
    </div>`;
  }).join('');
...
Object.assign(window, {
  ...
  annotateSharedGame, openWeakspotPosition,
});
