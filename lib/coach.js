...
function renderHeatmap() {
  ...
  el.innerHTML = `
    ...
    <div style="font-size:.75rem;color:var(--dim);margin-bottom:12px"><i class="ti ti-flame" aria-hidden="true"></i> Positions triées par taux d'erreur — les plus difficiles en premier. Survolez pour voir les élèves concernés.</div>
