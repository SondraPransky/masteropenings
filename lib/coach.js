    ...
    topErrors.forEach(e => {
      ...
      resumeHtml += `<div class="ed-review-item">
        ...
        <div style="flex:1;min-width:0">
          ...
          ${e.comment?`<div style="font-size:.75rem;color:var(--text-2);font-style:italic;line-height:1.4">« ${escapeHtml(e.comment.slice(0,90))}${e.comment.length>90?'…':''} »</div>`:''}
        </div>
...
function openWeakspotPosition(i) {
  ...
  body.innerHTML = `<div style="display:flex;gap:18px;flex-wrap:wrap;align-items:flex-start">
      ...
      <div style="flex:1;min-width:200px">
        ...
        ${p.comment ? `<div class="wsx-comment" style="margin:0 0 14px">« ${escapeHtml(p.comment)} »</div>` : ''}
