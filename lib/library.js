...
function _baseDetailHTML(b) {
  ...
  const list = games.length
    ...
    : `<div class="mcard-empty">
        ...
        <div class="mcard-empty-sub">Ajoute ta première partie : colle un PGN, ou saisis-la sur l'échiquier (bientôt).</div>
      </div>`;
  return `
...
function deleteGame(id) {
  ...
  save();
  // NB : suppression serveur (_sbDeleteGame) à câbler avec la persistance connectée (P1.3 / gate).
  renderMyLibrary();
