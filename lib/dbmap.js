...
function _sbModuleToRow(d) {
  return {
    ...
    extra:            { created: d.created || null, fromLibrary: !!d.fromLibrary, demo: !!d.demo, isExercise: !!d.isExercise, exType: d.exType || null, folder: d.folder || null,
                        // Groupe utilisateur (« Répertoire Groupe 1 ») : la dimension de rangement
                        // du répertoire, distincte du `folder` d'origine d'import. Migration-free.
                        group: d.group || null,
...
// ── Partie (bibliothèque de l'élève) ───────────────────────
...
function _sbRowToGame(row) {
  ...
  return {
    ...
    analysis:     ex.analysis || null,     // Assistant faiblesses : analyse moteur (weakness-core.js)
