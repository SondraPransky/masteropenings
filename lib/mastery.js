...
// sessions : résultats (recordResult) et pratique (recordPracticeSession).
// Le cœur pur est `leitnerSchedule` (core.js, échelons).
...
// Pont window : exposé aux appels app.js/lib (drill, sr, coach).
// `_scheduleMasterySync` reste interne (appelé seulement par sm2Update).
Object.assign(window, {
  sm2Update, sm2Get, recordPracticeSession, recordResult,
});
