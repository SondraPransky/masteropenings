...
function renderDrillList() {
  ...
  grid.innerHTML = list.map(({ d, i, due }) => {
    ...
    const badges = [
      ...
      // Module a chapitres (fichier multi-parties) : le nombre de lecons est un
      // repere de scan important quand une carte en cache 5.
      (d.varmode==='tree' && ns>1) ? `<span class="badge" style="background:var(--cyan-dim);color:var(--cyan)"><i class="ti ti-book-2" aria-hidden="true"></i> ${ns} chapitres</span>` : '',
