...
// producteurs. Plan à 2 pattes autorisé (les erreurs types s'ajoutent quand
// l'analyse a tourné).
//
...
function planComposerSave() {
  ...
  if (!puzzles.length && !errors.length) { window.toast?.('⚠ Attache au moins un paquet (puzzles ou erreurs types)', 'ko'); return; }
