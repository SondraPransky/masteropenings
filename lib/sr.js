...
function renderSrDashboard() {
  ...
  el.innerHTML =
    ...
    + `<div class="srdash-m"><div class="srdash-v" style="color:${dueNow>0?'var(--cyan)':'var(--dim)'}">${dueNow}</div><div class="srdash-l">À réviser</div></div>`
    ...
    + `<div class="srdash-m"><div class="srdash-v" style="color:${mature>0?'var(--gold)':'var(--dim)'}">${mature}</div><div class="srdash-l">Maîtrisées</div></div>`
