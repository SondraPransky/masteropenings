...
function renderSrDashboard() {
  ...
  el.innerHTML =
    ...
    + `<button class="btn btn-ghost btn-sm" style="font-size:.72rem" title="Réglages de la révision" onclick="openSrSettings()"><i class="ti ti-settings" aria-hidden="true"></i></button></div>`
    ...
    + `<div class="srdash-m"><div class="srdash-v" style="color:var(--gold)">${mature}</div><div class="srdash-l">positions bien retenues</div></div>`
