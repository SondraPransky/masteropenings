...
Object.assign(window, {
  _afterMaiaReady, _buildDrillTree, _checkPTEnd, _commentDelay, _commentWithShapes,
  _drawBoardShapes, _drillSessions, _ensureOrt, _findNodeByFen, _getHintFrom, _getMaiaMove,
  _initA11y, _materialHint, _mirrorFen, _mirrorUci, _nagGroup, _parseShapes, _pieceFr,
  ...
  drawCoords, drawGhost, editorTreeToPGN, enginePlay, escapeHtml, evXY, fig, flipBoard,
  getPieceImg, goPage, initDrillPage, isLineMode, isPlayerMove, loadMaia, loadStudentModules,
  loadTeacherGames, loadTeacherModules, loadTeacherPractice, loadTeacherResults, loginUser,
  logoutUser, nagGlyphs, nextDrill, nextSession, pgnToEditorTree, pickPromo, playVsMaia,
  posGhost, quitMaiaGame, recordPracticeSession, recordResult, registerUser,
  requestPasswordReset, resizeBoard, save, saveClasses, saveGame, selectDrill, setBoardComment,
  setBoardPrompt, setFeedback, showHint, showLoginError, showLoginTab, showPromoPicker,
  showRecoveryForm, skipPosition, sm2Get, sm2Update, sqFromXY, startDrill, startPostTheory,
  submitNewPassword, switchCoachSection, syncModuleToFirestore, toast, toggleTheme,
  totalSessions, tryMove, tryMovePostTheory, updateNav, updateScores, updateSessionInfo,
  updateStudentBar,
});
