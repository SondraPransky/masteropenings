...
Object.assign(window, {
  ...
  _commentDelay, _commentWithShapes, 
  _drawBoardShapes, _drillSessions, _ensureOrt, _findNodeByFen, _getHintFrom, _getMaiaMove, _initA11y,
  _materialHint, _mirrorFen, _mirrorUci, 
  _nagGroup, _parseShapes, _pieceFr, _sbAuthError, _sbDeleteClass,
  ...
  deleteModuleFromFirestore, dismissOnboarding, drawBoard, drawCoords, drawGhost,
  editorTreeToPGN, enginePlay, escapeHtml, evXY, 
  fig, flipBoard, getPieceImg, goPage, importDrill,
  initDrillPage, injectDemoDrill, isLineMode, isPlayerMove, launchDrill, 
  ...
  nextSession, openCreateDrillModal, openEditClass, openLibrary, 
  ...
  startPostTheory, submitNewPassword, switchCoachSection, syncModuleToFirestore, toast,
