...
interface Window {
  ...
  openGameTransfer?: (...a: any[]) => any;      // déplacer/copier/dupliquer une partie entre bases (lib/library.js)
  _gtSync?: (...a: any[]) => any;
  gameTransferRun?: (...a: any[]) => any;
  _libSetPosFilter?: (...a: any[]) => any;      // filtre par position posé par l'établi
  _libOpenBaseGames?: (...a: any[]) => any;
  _qeMount?: (...a: any[]) => any;              // établi de la bibliothèque (lib/library-etabli.js)
  qeUndo?: (...a: any[]) => any;
  qeReset?: (...a: any[]) => any;
  qePlaySan?: (...a: any[]) => any;
  qeSave?: (...a: any[]) => any;
  ...
  openChapterPaste?: (...a: any[]) => any;      // coller une partie dans un module (nouveau chapitre)
  chapterPasteRun?: (...a: any[]) => any;
  ...
  oaaPin?: (...a: any[]) => any;                // aperçu épinglé : clic (épingle/libère)
  oaaOpenPos?: (...a: any[]) => any;            // modale « La position »
  oaaAddToSel?: (...a: any[]) => any;
  oaaCreateOne?: (...a: any[]) => any;
  oaaLichessNote?: (...a: any[]) => any;        // note de croisement lue par Points faibles
  _oaaResetStuCache?: (...a: any[]) => any;
  ...
  _mcardMenuAnchor?: (...a: any[]) => any;      // ancrage du menu ⋯ d'une carte module
  importPgnBatch?: (...a: any[]) => any;        // import en lot de fichiers .pgn (lib/modules.js)
  pgnBatchCancel?: (...a: any[]) => any;
  ...
  openNewGameModal?: (...a: any[]) => any;  // modal « Nouvelle partie » (lib/library.js)
  _ngPrefillFromPgn?: (...a: any[]) => any;
